...
def _process_background_impl(recognizer, audio):
    ...
    try:
        ...
        if text_lower:
            ...
            print(f"\r🔍 [Debug STT Background] Ho sentito: '{text}'{' '*20}\n👤 Tu (scrivi o di' 'Argos...'): ", end="", flush=True)
...
def start_hybrid_listener():
    ...
    try:
        ...
        _stop_listening_fn = _recognizer.listen_in_background(_bg_mic, _process_background_audio, phrase_time_limit=10)
        return True
...
def get_hybrid_input(prompt="\n👤 Tu (scrivi o di' 'Argos...'): ") -> str:
    ...
    while not voice_command_queue.empty():
        try: voice_command_queue.get_nowait()
